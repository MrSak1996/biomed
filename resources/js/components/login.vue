          ...
          <div class="card-body">
            ...
            <div class="app-brand justify-content-center">
              <a href="index.html" class="app-brand-link gap-2">
                ...
                <span class="app-brand-text demo text-body fw-bolder">Biomed-CMMS</span>
              </a>
            </div>
            <!-- /Logo -->
            <h4 class="mb-2">Welcome to Biomed-CMMS! 👋</h4>
            <p class="mb-4">Please sign-in to your account and start the adventure</p>

            <form @submit.prevent="loginUser" id="formAuthentication" class="mb-3">
              <div class="mb-3">
